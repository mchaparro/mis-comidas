...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['office.ask-taltech-student.test.TODO.com', 'ask-taltech-student.test.TODO.com'])

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str('RAZZLE_SITE_URL', default='https://ask-taltech-student.test.TODO.com')
DJANGO_SITE_URL = env.str('RAZZLE_BACKEND_SITE_URL', default='https://office.ask-taltech-student.test.TODO.com')

CSRF_COOKIE_DOMAIN = env.str('DJANGO_CSRF_COOKIE_DOMAIN', default='.ask-taltech-student.test.TODO.com')
